...
def eval(net, dataset, save_dir=None):
    ...
    for i, (input, truth_bboxes, truth_labels, truth_masks, mask, image) in enumerate(dataset):
        try:
            ...
            del truth_bboxes, truth_labels, truth_masks, mask, image #, gt_mask, gt_img, pred_img, full, score
            ...
            if net.use_mask:
              del net.mask_probs, net.crop_boxes
    ...
    noduleCADEvaluation('./scripts/evaluationScript/annotations/LIDC/3_annotation.csv',
    './scripts/evaluationScript/annotations/LIDC/3_annotation_excluded.csv',
